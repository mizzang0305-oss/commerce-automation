...
- Product package prepare and execute request building must block static single-image-only videos, missing story script, missing why-buy reason, missing voiceover audio, fewer than 5 scenes, fewer than 5 captions, duration under 20 seconds, and developer/test placeholder descriptions.
- Story-driven package readiness requires hook, problem, product benefit, target customer, why-buy reason, caution/check-before-buy, CTA, Korean voiceover script, voiceover audio, product image, disclosure, affiliate URL, and content quality score at least 80.
