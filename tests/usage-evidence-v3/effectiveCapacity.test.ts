...
describe("V3 effective capacity", () => {
  test("proves active 69 and reserve 14 without changing scheduler thresholds", () => {
    ...
    expect(result.final.active).toBe(69);
    expect(result.final.reserve).toBe(14);
    expect(result.final.distinct).toBe(83);
