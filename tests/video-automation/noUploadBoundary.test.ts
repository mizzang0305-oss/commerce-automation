...
describe("no-upload boundary", () => {
  ...
  test("does not import platform, database, sheets, or upload adapters", async () => {
    const files = ["src/lib/video-automation/index.ts", "src/lib/video-automation/pipeline.ts", "src/lib/video-automation/layoutCollision.ts", "src/lib/video-automation/productFixtures.ts", "scripts/video-automation/run-product-to-video-v1.ts", "tools/video-automation/local_media_bridge.py"];
