...
function buildPackageInput(input: {
  ...
  const storyPackage = buildBilibinStainlessCookingToolsShortsPackage({
    ...
    image_generation_provider: input.contentQualityHints?.image_generation_provider ?? undefined,
    provider_mode: input.contentQualityHints?.provider_mode ?? undefined,
    final_upload_allowed: input.contentQualityHints?.final_upload_allowed === true,
    local_card_generator_used_for_final: input.contentQualityHints?.local_card_generator_used_for_final === true,
    shape_card_scene_allowed: input.contentQualityHints?.shape_card_scene_allowed === true,
    abstract_scene_allowed: input.contentQualityHints?.abstract_scene_allowed === true,
    real_scene_image_provider_configured: input.contentQualityHints?.real_scene_image_provider_configured === true,
    photorealistic_scene_provider_configured: input.contentQualityHints?.photorealistic_scene_provider_configured === true,
    photorealistic_score: input.contentQualityHints?.photorealistic_score ?? undefined,
    photorealistic_scene_count: input.contentQualityHints?.photorealistic_scene_count ?? undefined,
    vector_or_shape_scene_count: input.contentQualityHints?.vector_or_shape_scene_count ?? undefined,
    abstract_scene_count: input.contentQualityHints?.abstract_scene_count ?? undefined,
    unrealistic_hand_detected: input.contentQualityHints?.unrealistic_hand_detected === true,
    product_identity_consistency_score: input.contentQualityHints?.product_identity_consistency_score ?? undefined,
    generated_scene_image_count: input.contentQualityHints?.generated_scene_image_count ?? undefined,
    unique_scene_image_hash_count: input.contentQualityHints?.unique_scene_image_hash_count ?? undefined,
    generated_scene_images_are_not_color_cards: input.contentQualityHints?.generated_scene_images_are_not_color_cards === true,
    generated_scene_images_are_visually_distinct: input.contentQualityHints?.generated_scene_images_are_visually_distinct === true,
    scene_image_color_palette_delta_pass: input.contentQualityHints?.scene_image_color_palette_delta_pass === true,
    scene_image_semantic_kind_unique: input.contentQualityHints?.scene_image_semantic_kind_unique === true,
    product_image_reuse_ratio: input.contentQualityHints?.product_image_reuse_ratio ?? undefined,
    color_card_only_ratio: input.contentQualityHints?.color_card_only_ratio ?? undefined,
    ...
    use_case_human_context_present: input.contentQualityHints?.use_case_human_context_present === true,
    use_case_kitchen_context_present: input.contentQualityHints?.use_case_kitchen_context_present === true,
    utensil_interaction_present: input.contentQualityHints?.utensil_interaction_present === true,
    human_use_signal_scene_count: input.contentQualityHints?.human_use_signal_scene_count ?? undefined,
    human_or_hand_usage_signal_scene_count: input.contentQualityHints?.human_or_hand_usage_signal_scene_count ?? undefined,
    kitchen_context_scene_count: input.contentQualityHints?.kitchen_context_scene_count ?? undefined,
    utensil_interaction_scene_count: input.contentQualityHints?.utensil_interaction_scene_count ?? undefined,
    real_usage_scene_count: input.contentQualityHints?.real_usage_scene_count ?? undefined,
    abstract_shape_card_scene_count: input.contentQualityHints?.abstract_shape_card_scene_count ?? undefined,
    real_usage_scene_pass: input.contentQualityHints?.real_usage_scene_pass === true,
    real_usage_visual_present: input.contentQualityHints?.real_usage_visual_present === true,
    shape_card_scene_detected: input.contentQualityHints?.shape_card_scene_detected === true,
    shape_card_scene_count: input.contentQualityHints?.shape_card_scene_count ?? undefined,
    abstract_scene_ratio: input.contentQualityHints?.abstract_scene_ratio ?? undefined,
...
function buildContentQualityHints(asset: ProductAsset) {
  ...
  return {
    ...
    image_generation_provider: safeTrim(metadata.image_generation_provider) || null,
    provider_mode: safeTrim(metadata.provider_mode ?? metadata.image_generation_provider_mode) || null,
    final_upload_allowed: metadata.final_upload_allowed === true,
    local_card_generator_used_for_final: metadata.local_card_generator_used_for_final === true,
    shape_card_scene_allowed: metadata.shape_card_scene_allowed === true,
    abstract_scene_allowed: metadata.abstract_scene_allowed === true,
    real_scene_image_provider_configured: metadata.real_scene_image_provider_configured === true,
    photorealistic_scene_provider_configured: metadata.photorealistic_scene_provider_configured === true,
    photorealistic_score: normalizeOptionalNonNegativeNumber(metadata.photorealistic_score),
    photorealistic_scene_count: normalizeOptionalNonNegativeNumber(metadata.photorealistic_scene_count),
    vector_or_shape_scene_count: normalizeOptionalNonNegativeNumber(metadata.vector_or_shape_scene_count),
    abstract_scene_count: normalizeOptionalNonNegativeNumber(metadata.abstract_scene_count),
    unrealistic_hand_detected: metadata.unrealistic_hand_detected === true,
    product_identity_consistency_score: normalizeOptionalNonNegativeNumber(metadata.product_identity_consistency_score),
    generated_scene_image_count: normalizeOptionalNonNegativeNumber(metadata.generated_scene_image_count),
    unique_scene_image_hash_count: normalizeOptionalNonNegativeNumber(metadata.unique_scene_image_hash_count),
    generated_scene_images_are_not_color_cards: metadata.generated_scene_images_are_not_color_cards === true,
    generated_scene_images_are_visually_distinct: metadata.generated_scene_images_are_visually_distinct === true,
    scene_image_color_palette_delta_pass: metadata.scene_image_color_palette_delta_pass === true,
    scene_image_semantic_kind_unique: metadata.scene_image_semantic_kind_unique === true,
    product_image_reuse_ratio: normalizeOptionalRatio(metadata.product_image_reuse_ratio),
    color_card_only_ratio: normalizeOptionalRatio(metadata.color_card_only_ratio),
    ...
    use_case_human_context_present: metadata.use_case_human_context_present === true,
    use_case_kitchen_context_present: metadata.use_case_kitchen_context_present === true,
    utensil_interaction_present: metadata.utensil_interaction_present === true,
    human_use_signal_scene_count: normalizeOptionalNonNegativeNumber(metadata.human_use_signal_scene_count),
    human_or_hand_usage_signal_scene_count: normalizeOptionalNonNegativeNumber(metadata.human_or_hand_usage_signal_scene_count),
    kitchen_context_scene_count: normalizeOptionalNonNegativeNumber(metadata.kitchen_context_scene_count),
    utensil_interaction_scene_count: normalizeOptionalNonNegativeNumber(metadata.utensil_interaction_scene_count),
    real_usage_scene_count: normalizeOptionalNonNegativeNumber(metadata.real_usage_scene_count),
    abstract_shape_card_scene_count: normalizeOptionalNonNegativeNumber(metadata.abstract_shape_card_scene_count),
    real_usage_scene_pass: metadata.real_usage_scene_pass === true,
    real_usage_visual_present: metadata.real_usage_visual_present === true,
    shape_card_scene_detected: metadata.shape_card_scene_detected === true,
    shape_card_scene_count: normalizeOptionalNonNegativeNumber(metadata.shape_card_scene_count),
    abstract_scene_ratio: normalizeOptionalRatio(metadata.abstract_scene_ratio),
