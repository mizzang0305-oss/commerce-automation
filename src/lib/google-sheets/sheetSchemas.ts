...
export class SheetsControlError extends Error {
  constructor(
    public readonly code: "GOOGLE_SHEETS_NOT_CONFIGURED" | "GOOGLE_SHEETS_READ_FAILED" |
      ...
      "ROW_CHANGED_RELOAD_REQUIRED" | "COMMAND_NOT_ALLOWED" | "COMMAND_STATE_CONFLICT" | "COMMAND_NAMESPACE_MISMATCH" |
      "QUEUE_NAMESPACE_REQUIRED" | "SHEETS_QUEUE_NAMESPACE_HEADER_REQUIRED" | "UNSAFE_SETTING_FORBIDDEN" |
