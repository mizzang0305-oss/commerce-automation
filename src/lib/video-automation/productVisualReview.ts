...
export function verifyProductVisualReview(input: {
  ...
  if (receipt.schema !== "product-visual-review/v1" || receipt.visualMode !== "product_information" ||
      ...
      !SHA256.test(receipt.audioSha256) || !SHA256.test(receipt.narrationSha256) ||
      ...
      !nonEmptyString(receipt.rightsEvidenceId) || !nonEmptyString(receipt.reviewerId) || !nonEmptyString(receipt.evidenceId) ||
