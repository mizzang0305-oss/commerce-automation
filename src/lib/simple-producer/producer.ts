...
function noOp(status: Extract<SimpleProducerRunResult["status"], "disabled" | "outside_slot" | "daily_target_reached" | "slot_already_recorded">, safeError: string, date: string, slot: string | null): SimpleProducerRunResult {
