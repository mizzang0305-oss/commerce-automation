...
const links = [
  ...
  ["/commerce-control/reserve", "예비상품"], ["/commerce-control/commands", "명령큐"], ["/commerce-control/logs", "실행로그"],
    ...
    <div className="mb-6 rounded-3xl bg-slate-950 p-4 text-white shadow-xl shadow-slate-200/60">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-xs text-slate-400">Local JSON 권위 · Sheets 명령/투영 · 업로드 없음</p>
          <p className="mt-2 inline-block rounded-full bg-emerald-300 px-3 py-1 text-xs font-black text-slate-950">NO UPLOAD / NO POST / LOCAL ARTIFACTS ONLY</p>
